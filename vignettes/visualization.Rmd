...
## Using flatten() for Individual Value Plots

The `flatten()` function converts the matrix to long format, perfect for plotting individual values:
...
- Use `flatten()` for individual data point visualization
